...
export default function GeneratePassword() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-400 dark:bg-slate-400">
      {/* Center the password generator card within the screen */}
      <Card className="w-full max-w-md p-6 bg-white dark:bg-blue-800 shadow-lg rounded-lg">
  ...
  <h1 className="text-2xl font-bold text-blue-800">Developed By:</h1>
  <h1 className="text-2xl font-bold text-blue-800">Hareem Jaweid</h1>
</div>
